...
<div class="content">
        ...
        <div  class="register-domain" align="center">
            <form action="/account/default/registerDomain" method="POST" class="form-horizontal form">			
                ...
                <input  value="<?php echo htmlspecialchars(json_encode($ids)); ?>" name="ids" type="hidden">
                <h3>Registering domain(s)</h3>
                        <ul>
                    <?php foreach ($domains as $key => $value) { ?>
                            <li><?php echo $value['domain']; ?></li>
                    <?php } ?>
                        </ul>

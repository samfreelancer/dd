...
<div class="content">
	<div class="container-fluid ">
		<div class="container ">
		<div> <img alt="User Pic" src="https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=100" class="img-circle"> <br/><br/></div>     
			...
			<div class="row">
				<div class=" col-md-12 "> 
					...
					<a class="btn gb" data-toggle="modal" data-target="#edit" ><i class="fa fa-gear"></i> Edit Profile</a>
					<!--<a class="btn gb" href="/account/default/changePassword" ><i class="fa fa-gear"></i> Change Password</a>  -->
					<a class="btn gb" data-toggle="modal" data-target="#change_password" ><i class="fa fa-gear"></i> Change Password</a>
				</div>
			</div>
		</div>
	</div>

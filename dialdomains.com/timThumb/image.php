...
define ('CACHE_CLEAR', 500);                // maximum number of files to delete on each cache clear
...
define ('MAX_FILE_SIZE', 3500000);            // file size limit to prevent possible DOS attacks (roughly 1.5 megabytes)

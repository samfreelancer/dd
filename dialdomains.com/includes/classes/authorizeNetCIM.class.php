...
class AuthnetCIM
{
    ...
    private function parseResults()
    {
		...
		$this->customerProfile  = (array) $xml->profile;
		$this->paymentProfile  = (array) array_merge((array)$xml->paymentProfile->billTo,(array)$xml->paymentProfile->payment->creditCard,array('customerPaymentProfileId'=>(int)$xml->paymentProfile->customerPaymentProfileId));
		$this->shippingProfile  = (array) $xml->address;
